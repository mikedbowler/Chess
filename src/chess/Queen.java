...
public class Queen extends Piece{
	 ...
	 */
	public Queen(String name, int posx, int posy, String color, String sqrColor) {
	...
	public boolean isLegalMove(int destX, int destY)
	{
		...
		//Move diagonal
		else if((Math.abs(stepUpDown) == Math.abs(stepLeftRight)) && isPathClear(destX,destY))
		{
			return true;
		}
	...
	{
		/*For queen possible move directions include: Up/Down/Left/Right, 
